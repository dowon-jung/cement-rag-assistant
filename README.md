...
**우덕재단 장학생 선발 시스템**에서 Claude API를 활용해 자기소개서 자동 분석·채점·면접 질문 생성 시스템을 직접 설계하고 구현했습니다. Multi-Agent 구조, 코드 리뷰 Agent, SQL 리뷰 Agent를 직접 만들면서 AI가 실제 업무를 바꿀 수 있다는 것을 확인했습니다.
